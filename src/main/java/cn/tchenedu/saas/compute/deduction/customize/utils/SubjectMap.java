...
public class SubjectMap {
    ...
    public static Map<Integer,String> SUBJECT_MAP;


    public static Map<String,Integer> COMPOSE_WEIGHT_MAP;

    public static final int FLUCTUATE = 5;//浮动值 暂时给固定值

    static {

        if (true){
            SUBJECT_MAP = new HashMap<>();
            SUBJECT_MAP.put(1 << 6,"物理");
            SUBJECT_MAP.put(1 << 5,"化学");
            SUBJECT_MAP.put(1 << 4,"生物");
            SUBJECT_MAP.put(1 << 3,"政治");
            SUBJECT_MAP.put(1 << 2,"地理");
            SUBJECT_MAP.put(1 << 1,"历史");
            SUBJECT_MAP.put(1 << 0,"技术");
        }
